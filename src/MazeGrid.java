...
public class MazeGrid extends JFrame {
    ...
    {
        pathColor = new Color(200,255,250);
        DIMENSION = dimension;
        this.solver = solver;
        setWindowAttributes();
        setLookAndFeel();
    ...
    private void setLookAndFeel() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Required Metal Look and Feel resources unavailiable. The Program will run, but may not look right.");
        }
    }
